  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<MessageRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        final chatMessageRecord = chatMessageRecordList.isNotEmpty
            ? chatMessageRecordList.first
            : null;
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            'https://image.freepik.com/free-vector/sphere-grid-wave-with-binary-code-ai-artificial-intelligence-logo-hands-machine-learning-concept_127544-856.jpg',
                                            width: 70.0,
                                            height: 70.0,
                                            fit: BoxFit.cover,
                                          ),
