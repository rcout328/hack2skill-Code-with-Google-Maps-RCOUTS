...
class _RestWidgetState extends State<RestWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<RestaurantsRecord>(
      stream: RestaurantsRecord.getDocument(widget.rest!),
      builder: (context, snapshot) {
        ...
        final restRestaurantsRecord = snapshot.data!;
                  ...
                  children: [
                    Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          'https://coveteur.com/wp-content/uploads/2018/03/london-regent-street-best-restaurants-2.jpg',
                    ...
                    StreamBuilder<List<MenuRecord>>(
                      stream: queryMenuRecord(
                        queryBuilder: (menuRecord) => menuRecord.where(
                          'resturant',
                          isEqualTo: restRestaurantsRecord.name,
                        ),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
