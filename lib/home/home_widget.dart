  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ChatRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ChatRecord> homeChatRecordList = snapshot.data!;
        final homeChatRecord =
            homeChatRecordList.isNotEmpty ? homeChatRecordList.first : null;
                      ...
                      child: StreamBuilder<List<RestaurantsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<RestaurantsRecord>
                              listViewRestaurantsRecordList = snapshot.data!;
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 5.0, 0.0, 0.0),
                                            child: Text(
                                              listViewRestaurantsRecord.address,
                                              style:
