...
import 'schema/chat1_record.dart';
...
export 'schema/chat1_record.dart';
...
/// Functions to query Chat1Records (as a Stream and as a Future).
Future<int> queryChat1RecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      Chat1Record.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<Chat1Record>> queryChat1Record({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      Chat1Record.collection,
      Chat1Record.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<Chat1Record>> queryChat1RecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
